		   ...
		   void checker() {
			   if (counter == 1) {
				   if (selectedButton == 2) {  // Правильный ответ на кнопке 2
					   ...
					   aaFinal::correctAnswers++; // Увеличиваем количество правильных ответов
				   }
				   else {
					   this->button1->BackColor = System::Drawing::Color::Red;
					   this->button2->BackColor = System::Drawing::Color::Green;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::myhp--; // Увеличиваем количество правильных ответов
				   }
			   }

			   // Для второго вопроса
			   if (counter == 2) {
				   if (selectedButton == 1) {  // Правильный ответ: Марлин (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
				   }
				   else {
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
			   ...
			   if (counter == 3) {
				   if (selectedButton == 2) {  // Правильный ответ: Проблемы с памятью (2)
					   this->button1->BackColor = System::Drawing::Color::Red;
					   this->button2->BackColor = System::Drawing::Color::Green;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 4) {
				   if (selectedButton == 1) {  // Правильный ответ: Черепахи (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 5) {
				   if (selectedButton == 2) {  // Правильный ответ: Жемчужинка (2)
					   this->button1->BackColor = System::Drawing::Color::Red;
					   this->button2->BackColor = System::Drawing::Color::Green;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   // Для шестого вопроса
			   if (counter == 6) {
				   if (selectedButton == 1) {  // Правильный ответ: Осьминог (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 7) {
				   if (selectedButton == 1) {  // Правильный ответ: Брюс (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 8) {
				   if (selectedButton == 1) {  // Правильный ответ: В океанариум (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 9) {
				   if (selectedButton == 1) {  // Правильный ответ: Краш (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 10) {
				   if (selectedButton == 1) {  // Правильный ответ: "Просто плыви!" (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 11) {
				   if (selectedButton == 1) {  // Правильный ответ: Рыба-хирург (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 12) {
				   if (selectedButton == 1) {  // Правильный ответ: Судьба (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 13) {
				   if (selectedButton == 3) {  // Правильный ответ: Ракушка с надписью (3)
					   this->button1->BackColor = System::Drawing::Color::Red;
					   this->button2->BackColor = System::Drawing::Color::Red;
			   ...
			   if (counter == 14) {
				   if (selectedButton == 1) {  // Правильный ответ: Учитель Немо (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
			   ...
			   if (counter == 15) {
				   if (selectedButton == 1) {  // Правильный ответ: Бекки (1)
					   this->button1->BackColor = System::Drawing::Color::Green;
					   this->button2->BackColor = System::Drawing::Color::Red;
					   this->button3->BackColor = System::Drawing::Color::Red;
					   aaFinal::correctAnswers++;
