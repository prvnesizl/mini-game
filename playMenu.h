...
//#define GLOBALS_H
//
//extern int hp = 3;  // Объявление глобальной переменной
//
//#endif
namespace Крабик {
	...
	/// Сводка для playMenu
	/// </summary>
	public ref class playMenu : public System::Windows::Forms::Form
	{
	public:
		playMenu(void)
		{
			...
			timer1->Tick += gcnew System::EventHandler(this, &playMenu::timer1_Tick);
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(playMenu::typeid));
			...
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Arial Narrow", 21.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
			...
			this->button1->Click += gcnew System::EventHandler(this, &playMenu::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &playMenu::button3_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &playMenu::pictureBox1_Click);
			this->pictureBox1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &playMenu::pictureBox1_Paint);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &playMenu::label1_Click);
			// 
			// pictureBox2
			// 
			this->pictureBox2->BackgroundImage = Image::FromFile("imheart.jpg");
			this->pictureBox2->Image = Image::FromFile("imheart.jpg");
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &playMenu::pictureBox2_Click);
			// 
			// pictureBox5
			// 
			this->pictureBox5->Image = Image::FromFile("imstar.jpg");
			...
			// pictureBox8
			// 
			this->pictureBox8->Image = Image::FromFile("imheart.jpg");
			...
			// pictureBox9
			// 
			this->pictureBox9->Image = Image::FromFile("imheart.jpg");
			...
			// pictureBox10
			// 
			this->pictureBox10->Image = Image::FromFile("imstar.jpg");
			...
			// pictureBox11
			// 
			this->pictureBox11->Image = Image::FromFile("imstar.jpg");
			...
			this->pictureBox3->Image = Image::FromFile("KRAB.png");
			...
			this->pictureBox3->Size = System::Drawing::Size(94, 91);
			this->pictureBox3->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
			this->pictureBox3->TabIndex = 16;
			this->pictureBox3->TabStop = false;
			this->pictureBox3->Click += gcnew System::EventHandler(this, &playMenu::pictureBox3_Click);
			// 
			// playMenu
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->BackgroundImage = Image::FromFile("BG2color.jpg");
			...
			this->Name = L"playMenu";
			this->Text = L"playMenu";
			this->Load += gcnew System::EventHandler(this, &playMenu::playMenu_Load);
...
#pragma endregion
	...
	private: System::Void playMenu_Load(System::Object^ sender, System::EventArgs^ e) {
